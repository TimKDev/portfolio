  ...
  stories: any = [
    {
      ...
      doing so. In my freetime I played saxophon in a wind orchestra.`,
      imgURL: './assets/icons/search.png'
    },
    {
      title: 'BACHELOR OF PHYSICS',
      description: `After my high school graduation I started studing physics at RWTH Aachen with a focus on 
    ...
    },
    {
      ...
      description: `After my Bachelor I started my Masters in theortical physics. Here 
      I worked in a research group studing an unsolved automatisation problem. By using my programming skills I was able
      to solved this problem during my master thesis. I completed my Masters after 2 years.`,
    ...
    },
    {
      ...
      after completing my collage education. There I fell in love with Web Development using HTML, CSS, JS and Angular. Now 
